...
CLOSURE_COMPILER_NPM = (
    os.path.join(_SCRIPT_DIR, "node_modules", ".bin", "google-closure-compiler.cmd")
    if os.name == "nt" else
    os.path.join(_SCRIPT_DIR, "node_modules", ".bin", "google-closure-compiler")
)
...
class Gen_compressed(threading.Thread):
  ...
  def write_output(self, target_filename, remove, json_data):
      ...
      if (compiledCode.find("new Blockly.Generator") != -1):
        code = HEADER + "\nlet Blockly = require(\'picoblock-blocks\');\n\n" + compiledCode
      else:
        code = HEADER + "\n" + compiledCode
